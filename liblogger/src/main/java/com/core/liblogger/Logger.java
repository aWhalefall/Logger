...
public final class Logger extends BaseLog {
        ...
        if(LOG_OPEN) {
            try {
                ...
                for (String key : bundle.keySet()) {
                    stringBuilder.append("[" + key + "," + bundle.get(key) == null ? "" : bundle.get(key).toString() + "]");
                }
    ...
    public static void Hs(@NonNull Object... msgs) {
        printLog(LogType.D, LogTag.mk("I/Unity: ="), null, parseMsgs(msgs));
    }
